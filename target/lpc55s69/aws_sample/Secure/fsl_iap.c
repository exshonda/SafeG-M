...
#define CPU_LPC55S69JBD100_cm33_core0 1
...
void __attribute__((alias("dummy_syscall"))) _exit(void);
void __attribute__((alias("dummy_syscall"))) _sbrk(void);
void __attribute__((alias("dummy_syscall"))) _kill(void);
void __attribute__((alias("dummy_syscall"))) _getpid(void);
void __attribute__((alias("dummy_syscall"))) _write(void);
void __attribute__((alias("dummy_syscall"))) _close(void);
void __attribute__((alias("dummy_syscall"))) _fstat(void);
void __attribute__((alias("dummy_syscall"))) _isatty(void);
void __attribute__((alias("dummy_syscall"))) _lseek(void);
void __attribute__((alias("dummy_syscall"))) _read(void);
