...
|---|---|---|---|
| 2026-06-17 | `27c1a15` | `3b548ab` | imxrt685 9/9・RP2350 9/9（A〜D1）初回 |
| 2026-06-17 | `d514720` | `722c445` | RP2350 9/9（A〜D1）。レビュー修正 #1/#2/#5 適用後 |

> 新しい組で green を取ったら**行を追加**すること（最新行が現行の正）。
> 注: asp3_core `722c445` は origin の `ed0a921`(docs: TTSP3 sweep) を含む rebase 後の HEAD。
